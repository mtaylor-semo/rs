...
## 
golem::fill_desc(
  pkg_name = "rs", # The Name of the package containing the App 
  pkg_title = "range_size", # The Title of the package containing the App 
  pkg_description = "Geographic range size exploration for Biogeography.", # The Description of the package containing the App 
